...
$\mutri_3(4)=9$, $\mutri_5(4)=8$, $\mutri_p(4)=7$ for all primes $7\leq p\leq 23$,
and $\mutri_3(5)=11$. Details about the computation can be found in Table~\ref{tab:alg},
...
and for $q\geq3$ we know no example where one of the inequalities in $\mu_q(k)\leq\musym_q(k)\leq\mutri_q(k)$
is strict. However, it turns out that the inequality with $\mutriG_q(k)$ can be strict.
Indeed, let $q=3$. For $k=2,3,4,5$ we found $\mutriG_3(k)=\mu_3(k)$. But for $k=7$ our exhaustive search
...
%  \centering
  ...
  \begin{tabular}{|c|c|c|}
    ...
    $a_1 = 2,\quad a_2 = 2\alpha,\, a_3 = a_2^\sigma,\, a_4 = a_3^\sigma,\, a_5 = a_4^\sigma,$\\
    ...
    $a_1 = 1,\quad a_2 = \alpha\!+\!2,\, a_3 = a_2^\sigma,\, a_4=a_3^\sigma,\, a_5=a_4^\sigma,\, a_6=a_5^\sigma, $\\
  ...
  3\alpha^2\!+\!\alpha$\\
   ...
   \multirow{2}{*}{$8$} & $a_1=-1,\, a_2 = 3\alpha^2\!+\!3\alpha\!+\!3,\, a_3 = 3\alpha^3\!+\!4\alpha^2\!+\!2\alpha\!+\!4,\, a_4 = 2\alpha^3\!+\!4\alpha^2\!+\!4\alpha\!+\!1,$\\ 
   $\quad\mathbb{F}_5[\alpha]/(\alpha^4\!-\!\alpha^2\!-\!\alpha\!+\!2)$&  & $a_5 = \alpha,\, a_6=4\alpha^2\!+\!\alpha,\, a_7 = \alpha^3\!+\!\alpha^2\!+\!\alpha,\, a_8 = \alpha^3\!+\!\alpha^2$\\
   \hline
  \end{tabular}
%  \endgroup
