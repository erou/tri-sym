...
%  \setlength{\tabcolsep}{2pt}
  ...
  \begin{tabular}{|c|c|c|}
    \hline
    Field & Polynonial & Elements $a_i$ such that $xy =
    \sum_i\ps{a_i}{x}\ps{a_i}{y}a_i$ (\ie $\lambda_i=1$) \\
    \hline
    \hline
    $\mathbb{F}_{3^3}$ & $T^3-T+1$ &
    $a_0 = \alpha, a_1 = a_0^\sigma, a_2 = a_1^{\sigma}, a_3 =
    1-\alpha^2, a_4=a_3^\sigma, a_5=a_4^{\sigma}$ \\ 
    \hline
    $\mathbb{F}_{3^4}$ & $T^4-T^3-1$ &
    $a_0 = 2, a_1 = 2\alpha, a_2 = a_1^\sigma, a_3 = a_2^\sigma, a_4 =
    a_3^\sigma, a_5 = \alpha^2+\alpha+1, a_6 = a_5^\sigma, a_7 = a_6^\sigma,
    a_8=a_7^\sigma$\\
    \hline
    \multirow{2}{*}{$\mathbb{F}_{3^5}$} & \multirow{2}{*}{$T^5-T+1$} &
    $a_0 = 1, a_1 = \alpha+2, a_2 = a_1^\sigma, a_3=a_2^\sigma, a_4=a_3^\sigma,
    a_5=a_4^\sigma, a_6 = 1-\alpha-\alpha^2, a_7=a_6^\sigma,$\\
    & & $a_8 = a_7^\sigma, a_9 = a_8^\sigma, a_{10} = a_9^\sigma $\\
    \hline
    $\mathbb{F}_{5^3}$ & $T^3+3T+3$ & $a_0 = 3\alpha+2,
  a_1=-(\alpha^2+\alpha+1), a_2 = 3\alpha^2+2\alpha+2, a_3=-\alpha, a_4 =
  3\alpha^2+\alpha$\\
   \hline
   \multirow{2}{*}{$\mathbb{F}_{5^4}$} &
   $T^4-T^2$ & $a_0=-1, a_1 =
   3\alpha^2+3\alpha+3, a_2 = 3\alpha^3+4\alpha^2+2\alpha+4, a_3 =
 2\alpha^3+4\alpha^2+4\alpha+1,$\\ 
 & $-T+2$ & $a_4 = \alpha, a_5=4\alpha^2+\alpha, a_6 = \alpha^3+\alpha^2+\alpha,
 a_7 = \alpha^3+\alpha^2$\\
   \hline
  \end{tabular}
%  \endgroup
  \caption{Examples of trisymmetric multiplication formulae.}
  \label{tab:formulae}
\end{table}
