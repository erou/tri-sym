...
\author{Hugues Randriambololona\inst{1,2} \and Édouard Rousseau\inst{2,3}\textsuperscript{(\Letter)}}
\institute{ANSSI, Paris, France
\and Institut Polytechnique de Paris / Télécom Paris, Palaiseau, France\\ \email{\{randriam,erousseau\}@telecom-paris.fr}
\and Université Paris-Saclay / UVSQ, Versailles, France}
...
%\vspace{.5\baselineskip}\noindent\textbf{Bilinear complexity.}
...
\[
  A = a_1 X + a_0\textrm{ and }B = b_1 X + b_0
\]
...
\vspace{.5\baselineskip}\noindent\textbf{Multilinear complexity.}
...
\vspace{.5\baselineskip}\noindent\textbf{Symmetric multilinear complexity.}
...
\begin{theorem}[{\cite[Thm.~A.7]{Randriam15}}]\label{th:criterion}
...
\vspace{.5\baselineskip}\noindent\textbf{Trisymmetric and hypersymmetric complexity.}
...
\vspace{.5\baselineskip}\noindent\textbf{Galois invariance.}
...
\vspace{.5\baselineskip}\noindent\textbf{Multiplication formulae in algebras.}
...
%complexity} and we write $\mu_{\textrm{sym}}(\A/\K)$. If $\A$ is commutative, then
%we always have $\mu_{\textrm{sym}}(\A/\K)<\infty$, and it is clear that 
%\[
%  \mu(\A/\K)\leq\mu_{\textrm{sym}}(\A/\K),
%\]
...
%is noted $\mu_{\textrm{tri}}(\A/\K)$. Once again, it is clear that
%\[
%  \mu(\A/\K) \leq \mu_{\textrm{sym}}(\A/\K)\leq\mu_{\textrm{tri}}(\A/\K),
%\]
...
\label{sec:algos}
\vspace{.5\baselineskip}\noindent\textbf{Algorithmic search.}
...
\[
  ...
  \,|\, \forall j\leq i-1,\,x_j=0\textrm{ and }x_i=1 \right\}
\]
and
\[
  \E = \bigcup_{i=1}^k\E_i.
...
\vspace{.5\baselineskip}\noindent\textbf{Galois invariant formulae.}
...
\vspace{.5\baselineskip}\noindent\textbf{Universal formulae.}
...
\begin{proposition}For any odd $q$ we have
\[
  \hmutri_q(2) = 3.
\]
\end{proposition}
...
\qed\end{proof}
\begin{proposition}For any $q$ not divisible by $2$ nor $3$ we have
\[
...
\vspace{.5\baselineskip}\noindent\textbf{Evaluation-interpolation method.}
...
\vspace{.5\baselineskip}\noindent\textbf{Choice of the curves for $q$ a large enough square.}
\begin{proposition}
...
\vspace{.5\baselineskip}\noindent\textbf{Conclusion for arbitrary $q$.}
\begin{lemma}
...
\vspace{.5\baselineskip}\noindent\textbf{Further remarks and possible improvements.}
\begin{enumerate}
